# 📚 Cronograma de Estudos v2.5

Uma aplicação de página única (**SPA**) projetada para organização offline robusta, intuitiva e altamente personalizável de rotinas de estudo. O projeto foi estruturado com foco educativo, contendo blocos de comentários detalhados sobre o funcionamento interno do HTML, CSS e JavaScript.

---

## 🎨 Interface e Design
* **Paleta de Cores:** Design profissional herdado do código original, utilizando tons de cinza, branco e azul primário para destaque.
